...
Context Window Manager 是 nomad 的核心组件，负责管理与 LLM 的对话上下文窗口。它提供自动 Token 计数、智能压缩和多种压缩策略，确保对话始终在 Token 预算内运行。
...
import (
    "context"
    "fmt"
    "github.com/nabob-ai/nomad/pkg/context"
)
