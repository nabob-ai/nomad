...
欢迎来到 nomad 架构文档！这里详细介绍了 nomad 的整体设计和各层实现。
...
nomad 的四层架构设计，包括核心 SDK、Server 层、HTTP 层和客户端 SDK 的整体架构。
...
`cmd/nomad` 目录下的开发 HTTP 服务实现，可替换框架。
...
从 [架构概览](./1.overview.md) 开始，了解 nomad 的整体设计理念。
...
参考 [客户端 SDK 架构](./4.client-sdk.md)，学习如何在应用中集成 nomad。
