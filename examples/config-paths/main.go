...
func demonstrateStandardPaths() {
	...
	fmt.Println("\n  平台路径约定:")
	fmt.Println("    macOS:")
	fmt.Println("      配置: ~/Library/Application Support/Nomad/")
	fmt.Println("      数据: ~/Library/Application Support/Nomad/")
	fmt.Println("      缓存: ~/Library/Caches/Nomad/")
	fmt.Println("      日志: ~/Library/Logs/Nomad/")
	fmt.Println()
	fmt.Println("    Linux:")
	fmt.Println("      配置: ~/.config/nomad/")
	fmt.Println("      数据: ~/.local/share/nomad/")
	fmt.Println("      缓存: ~/.cache/nomad/")
	fmt.Println("      日志: ~/.local/state/nomad/logs/")
	fmt.Println()
	fmt.Println("    Windows:")
	fmt.Println("      配置: %APPDATA%\\Nomad\\")
	fmt.Println("      数据: %APPDATA%\\Nomad\\data\\")
	fmt.Println("      缓存: %LOCALAPPDATA%\\Nomad\\cache\\")
	fmt.Println("      日志: %LOCALAPPDATA%\\Nomad\\logs\\")
}
...
func demonstrateEnsureDir() {
	...
	// 创建临时目录用于测试
	tmpDir, err := os.MkdirTemp("", "nomad-config-demo")
	if err != nil {
